...
<head>
  ...
  <title>Admin Sekolah | Entry Data</title>
            ...
            <div class="card card-lightblue">
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputNUPTK1">NUPTK</label>
                    <input type="text" class="form-control" id="exampleInputNUPTK1" placeholder="Masukkan NUPTK . . .">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputNama1">Nama</label>
                    <input type="text" class="form-control" id="exampleInputNama1" placeholder="Masukkan Nama . . .">
                  </div>
                  <div class="form-group">
